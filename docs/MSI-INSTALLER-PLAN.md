...
| M4: release pipeline | Pinned Windows packaging CI, artifact validation, signing, checksums, notices, draft GitHub release | Installed payload signatures and hashes verified; clean-machine acceptance matrix passes |
