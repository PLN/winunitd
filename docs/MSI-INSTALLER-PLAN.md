...
| R6.1 / R6.4 (former M2) | Package project, version metadata, files, ACLs, PATH, service/event source, quiet install, repair, uninstall | Fresh offline install/repair/uninstall; retained user state. One SYSTEM guest is recorded as `9961798-r64-accept`; the claimed SKUs are still required. The harness is `tests/installer` |
