...
| R6.1 / R6.4 (former M2) | Package project, version metadata, files, ACLs, PATH, service/event source, quiet install, repair, uninstall | Fresh offline install/repair/uninstall; retained user state. Native matrix evidence is still required; the harness is `tests/installer` |
