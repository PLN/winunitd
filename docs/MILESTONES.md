...
R2, R3, and R5 have completed their technical acceptance. R0, R1, R4, and R6 remain
...
Overall R6 stays open. Remaining: deferred-media and deferred-older-msi as listed under R6.4 and in [R6 evidence](R6-EVIDENCE.md#7d21de2-r64-finish). R6.5 is checked under `4223ac9-r65-migrate`. #245 is closed. Reopen those deferred rows from these lists. A3 / R4.4 stay deferred. R7 has not started.
