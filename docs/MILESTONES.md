...
- [ ] **R2.3 Scheduling:** ordinary/diagnostic/stop overload and completion progress passed combined control tests; reserved maintenance quiesced real workloads with all 128 ordinary connections occupied. [Acceptance evidence](R2-EVIDENCE.md#control-overload-and-reserved-maintenance-acceptance). Remaining: complete native-work priority and the full worker-class audit. Handler extraction alone does not satisfy this gate.
