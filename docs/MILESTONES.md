...
- [ ] **R0.4 Windows harness:** define disposable VM setup and evidence collection for SCM, SYSTEM, standard users, sessions, reboot, and installer failure injection. Establish a baseline smoke run with its actual identity recorded.
