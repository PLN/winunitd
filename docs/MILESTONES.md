...
- [ ] **R0.5 Packaging spike:** tooling terms are settled, three authoring modes and a rollback-aware helper are implemented, and initial guest experiments are recorded in the [packaging spike](PACKAGING-SPIKE.md). Final deadline/post-removal rollback qualification and artifact identities remain pending.
