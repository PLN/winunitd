...
- [ ] **R3.5 Native features:** native CPU scales and retained path/registry/eventlog conformance passed SYSTEM/headless-user qualification at `a2ed9b4`; [evidence](R3-EVIDENCE.md#dependency-and-native-trigger-conformance). Remaining: expose proxy ownership/capabilities in diagnostics. Unqualified behavior remains rejected or marked experimental.
