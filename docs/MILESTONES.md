...
Overall R6 stays open. Remaining: native R6.5 fixture qualification (`4223ac9-r65-migrate`); deferred-media and deferred-older-msi as listed under R6.4 and in [R6 evidence](R6-EVIDENCE.md#7d21de2-r64-finish). #245 is closed. Reopen those deferred rows from these lists. A3 / R4.4 stay deferred. R7 has not started.
