...
**Later:** ExecStop / CTRL_BREAK / WM_CLOSE, SCM proxy, GUI attach, SessionPolicy, LoadCredential, WatchdogMode=window — as described in DESIGN.md.
