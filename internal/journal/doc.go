...
// Writers emit v=4 (timestamp, unit, pid, stream, message, invocationId,
...
// Readers accept mixed v=1/v=2/v=3/v=4 files: v=1 lines decode with empty
// severity/session/userSid. V4 capture leaves severity unknown independently
// of stream; explicit diagnostics keep their level. Old files are not rewritten.
