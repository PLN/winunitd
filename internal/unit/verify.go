...
// It does not require a running daemon. A .registry unit also requires
// the companion basename .service next to the file.
func VerifyPath(path string) Report {
	...
	if rep.Unit != nil && rep.Unit.Kind == KindRegistry {
